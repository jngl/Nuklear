...
nk_button_text(struct nk_context *ctx, const char *title, int len)
{
 ...
 nk_bool nk_button_label_styled(struct nk_context *ctx,
    ...
    const char* text, int len, nk_flags align)
{
 ...
 nk_bool nk_button_symbol_label(struct nk_context *ctx, enum nk_symbol_type symbol,
    const char *label, nk_flags align)
{
    return nk_button_symbol_text(ctx, symbol, label, nk_strlen(label), align);
}
 nk_bool nk_button_symbol_label_styled(struct nk_context *ctx,
    const struct nk_style_button *style, enum nk_symbol_type symbol,
    ...
    const char *text, int len, nk_flags align)
{
 ...
 nk_bool nk_button_image_label(struct nk_context *ctx, struct nk_image img,
    const char *label, nk_flags align)
{
    return nk_button_image_text(ctx, img, label, nk_strlen(label), align);
}
 nk_bool nk_button_image_label_styled(struct nk_context *ctx,
